...
class RaspberryCamera(QObject):
    ...
    def set_gamma(self, value):
        self.__capture.set(cv2.CAP_PROP_GAMMA, value)
    ...
    def set_exposure_continuous(self):
        self.__capture.set(cv2.CAP_PROP_AUTO_EXPOSURE, 255)
...
if __name__ == '__main__':
    ...
    live_feed = RaspberryCamera(device_nr, supported_resolution_pi_v2[3])
